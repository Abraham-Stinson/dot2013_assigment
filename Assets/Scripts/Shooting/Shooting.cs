...
public class Shooting : MonoBehaviour
{
    ...
    public void PolarBearSpawn()
    {
        ...
        if (randomSide == 0)
        {
            ...
            polarBear.transform.localScale = new Vector3(-0.37775f, 0.37775f, 0.37775f);
        }
